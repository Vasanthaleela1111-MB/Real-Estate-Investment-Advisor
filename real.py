...
data=pd.read_csv("C:\AIML\Projects\Real Estate Investment Advisor\cleaned_data.csv")
df=pd.read_csv("C:\AIML\Projects\Real Estate Investment Advisor\Feature_data.csv")
india=pd.read_csv("C:\AIML\Projects\Real Estate Investment Advisor\india_housing_prices.csv")
